...
import adminBg from '/assets/admin-bg-navidad.png';// Cambiar a la imagen deseada de fondo general
          ...
          <div className="mx-auto max-w-6xl px-4 py-3 flex justify-between items-center">
            <div className="flex items-center gap-3">
              <div className="bg-white rounded-full p-1 shadow-md ring-2 ring-[hsl(24_100%_50%/_0.6)]">
                <img
                  src={conf?.logo_url || '/assets/logo-admin-navidad.png'} // Cambiar logo si se desea
                  alt="Logo"
