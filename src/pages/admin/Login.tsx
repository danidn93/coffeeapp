...
import adminBgDesktop from '/assets/admin-bg-navidad.png'; //Cambiar a la imagen deseada
import adminBgMobile from '/assets/movil-bg-navidad.png'; //Cambiar a la imagen deseada
import logo from '/assets/logo-admin-navidad.png'; //Cambiar al logo deseado
